...
const inactiveCollegesData = dummyColleges.filter(c => c.status === 'Inactive');

function InactiveColleges() {
  ...
  return (
    <div className="max-w-7xl mx-auto h-full flex flex-col">
      {/* Header & Breadcrumb */}
      <div className="mb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2">Inactive Colleges</h1>
        <div className="flex items-center text-[12px] text-gray-500 font-medium">
          ...
          <span className="text-gray-800 font-semibold">Inactive Colleges</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto">
          <table className="w-full min-w-[900px] text-left border-collapse">
            ...
            <tbody>
              {inactiveCollegesData.map((college) => (
                <tr key={college.id} className="border-b border-gray-50 hover:bg-gray-50/30 transition-colors">
                  ...
                  <td className="py-3 px-5 text-center">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button title="Activate" className="p-1.5 text-orange-500 hover:text-orange-600 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors">
                        <Power size={15} />
                      </button>
...
export default InactiveColleges;
