      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex-1 flex flex-col overflow-hidden">
        ...
        <div className="p-4 sm:p-5 border-b border-gray-100 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <Link to="/create-college" className="w-full sm:w-auto">
            <button className="w-full sm:w-auto px-5 py-2 text-[13px] font-bold text-white bg-[#008744] rounded-lg shadow-sm hover:bg-[#007338] transition-colors flex items-center justify-center gap-2 cursor-pointer">
              <Plus size={16} />
              Create College
            </button>
          </Link>
              ...
              <tbody>
                {paginatedColleges.length > 0 ? paginatedColleges.map((college) => (
                  <tr key={college._id} className="border-b border-gray-50 hover:bg-gray-50/30 transition-colors">
                    ...
                    <td className="py-3 px-5 whitespace-nowrap">
                      <Link to={`/college-details/${college._id}`} className="text-[13px] font-semibold text-gray-800 hover:text-[#008744] hover:underline transition-colors">
                        {college.collegeName}
                      </Link>
                    </td>
                    ...
                    <td className="py-3 px-5 text-center whitespace-nowrap">
                      <span className={`inline-flex items-center justify-center px-2.5 py-1 text-[11px] font-bold rounded-md ${
                        college.isActive ? 'bg-emerald-100 text-[#008744]' : 'bg-red-100 text-red-500'
                      }`}>
                    ...
                    <td className="py-3 px-5 text-center whitespace-nowrap">
                      <div className="flex items-center justify-center gap-2">
                        <Link to={`/college-details/${college._id}`}>
                          <button title="View Details" className="p-1.5 text-[#008744] hover:text-[#007338] bg-emerald-50 hover:bg-emerald-100 rounded-lg transition-colors cursor-pointer">
                            <Eye size={15} />
                          </button>
                        </Link>
                        <Link to={`/edit-college/${college._id}`}>
                          <button title="Edit College" className="p-1.5 text-[#FF7A00] hover:text-[#E66B00] bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors cursor-pointer">
                            <Edit size={15} />
                          </button>
                        </Link>
                        <button 
