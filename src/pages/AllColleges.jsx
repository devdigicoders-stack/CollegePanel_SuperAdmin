                ...
                <tr key={college.id} className="border-b border-gray-50 hover:bg-gray-50/30 transition-colors">
                  ...
                  <td className="py-3 px-5 text-center">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button title={college.status === 'Active' ? 'Deactivate' : 'Activate'} className={`p-1.5 rounded-lg transition-colors ${college.status === 'Active' ? 'text-green-600 hover:text-green-700 bg-green-50 hover:bg-green-100' : 'text-orange-500 hover:text-orange-600 bg-orange-50 hover:bg-orange-100'}`}>
                        <Power size={15} />
                      </button>
